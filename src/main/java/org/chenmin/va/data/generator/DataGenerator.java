package org.chenmin.va.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import org.chenmin.va.data.service.SamplePersonRepository;
import org.chenmin.va.data.entity.SamplePerson;
import org.chenmin.va.data.service.UserRepository;
import org.chenmin.va.data.entity.User;
import java.util.Collections;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.chenmin.va.data.Role;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 10, 10, 0, 0, 0));
